...
namespace FundManagementTest
{
    ...
    public class FundManagementViewModelTests
    {
        ...
        [TestMethod]
        public void EquityToleranceBreachedMarketValueTrueTest() 
        {
            var fundManagementVM = new FundManagementViewModel();

            fundManagementVM.AddStock(StockType.Equity, 150, -5000);

            var equity = fundManagementVM.StockData.FirstOrDefault();

            Assert.IsTrue(equity.ToleranceBreached);

        }

        [TestMethod]
        public void EquityToleranceBreachedMarketValueFalseTest()
        {
            var fundManagementVM = new FundManagementViewModel();
            ...
            Assert.IsFalse(equity.ToleranceBreached);

        }

        [TestMethod]
        public void EquityToleranceBreachedTransactionCostTrueTest()
        {
            var fundManagementVM = new FundManagementViewModel();

            fundManagementVM.AddStock(StockType.Equity, 41, 1000000);
        ...
        [TestMethod]
        public void EquityToleranceBreachedTransactionCostFalseTest()
        {
            var fundManagementVM = new FundManagementViewModel();


            fundManagementVM.AddStock(StockType.Equity, 39, 1000000);
        ...
        public void BondToleranceBreachedMarketValueTrueTest()
        {
            var fundManagementVM = new FundManagementViewModel();

            fundManagementVM.AddStock(StockType.Bond, 150, -5000);

            var bond = fundManagementVM.StockData.FirstOrDefault();

            Assert.IsTrue(bond.ToleranceBreached);

        }

        [TestMethod]
        public void BondToleranceBreachedMarketValueFalseTest()
        {
            var fundManagementVM = new FundManagementViewModel();
            ...
            Assert.IsFalse(bond.ToleranceBreached);

        }

        [TestMethod]
        public void BondToleranceBreachedTransactionCostTrueTest()
        {
            var fundManagementVM = new FundManagementViewModel();

            fundManagementVM.AddStock(StockType.Bond, 6, 1000000);
        ...
        [TestMethod]
        public void BondToleranceBreachedTransactionCostFalseTest()
        {
            var fundManagementVM = new FundManagementViewModel();

            fundManagementVM.AddStock(StockType.Bond, 4, 1000000);
